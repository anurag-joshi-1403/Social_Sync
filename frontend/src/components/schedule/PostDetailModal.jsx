...
const PostDetailModal = ({ post, onClose }) => {
  ...
  const handleSave = () => {
    ...
    updatePost(post.id, {
      content: caption,
      hashtags,
      scheduledTime: scheduleTime ? new Date(scheduleTime).toISOString() : null,
    });
          ...
          <div className="modal-content border-0 shadow-lg">
            <div className="modal-header border-0">
              <div className="d-flex align-items-center">
                <div
                  ...
                  style={{ background: platform.gradient, width: 42, height: 42, fontSize: '1.1rem' }}
                >
                ...
                <div>
                  ...
                  <small className="text-muted">
                    {platform.name} · <span className={`badge bg-${statusBadge} text-capitalize`}>{post.status}</span>
                  </small>
                </div>
              </div>
            ...
            <div className="modal-footer border-0">
              {editMode ? (
                ...
                <>
                  <button className="btn btn-outline-danger me-auto" onClick={handleDelete}>
