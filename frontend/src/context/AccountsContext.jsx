...
// Platform metadata lives in ../constants/platforms.js — import it from there.
...
export const AccountsProvider = ({ children }) => {
  ...
  // See the matching note in PostsContext: this is external-data fetching
  // keyed on auth state, not cascading render state.
  useEffect(() => {
